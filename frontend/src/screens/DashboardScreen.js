...
const DashboardScreen = ({ history }) => {
        ...
        for (var i = 0; i < (sales.length > 3 ? 4 : sales.length); i++) {
            indents.push(
                <tr key={sales[i].id}>
                    ...
                    <td className="h4">
                        {sales[i].delivery ? (
                            <span className={"badge bg-primary"}>PEDIDO LOCAL</span>
                        ) : (
    ...
    const renderSmallBoxes = () => (
        <>
            ...
            <SmallBox
                ...
                paragraph={"Pedidos para delivery"}
                link={"delivery"}
                color={"danger"}
                icon={"fas fa-truck"}
            />
    ...
    const renderSales = () => (
        <div className="row">
            <div className="col-12 col-lg-6">
                <div className="card">
                    <div className="card-header border-0">
                        <h3 className="card-title">Ultimas vendas</h3>
            ...
            <div className="col-12 col-lg-6">
                <div className="card">
                    <div className="card-header border-0">
                        <h3 className="card-title">Atos</h3>
                    </div>
    ...
    return (
        <>
            <HeaderContent name={"Gerenciador"} />
                        ...
                        <div className="col-12 col-md-3">
                            <div className="card">
                                <div className="card-header">
                                    <h3 className="card-title">
                                    Pedidos de entrega adicionados recentemente
                                    </h3>
                                    <div className="card-tools">
                                        <button
                                            type="button"
                                ...
                                <div className="card-footer text-center">
                                    <Link
                                        ...
                                        className="uppercase"
                                    >
                                         Ver todos os pedidos de entrega
                                    </Link>
                                </div>
                            </div>
                        </div>
