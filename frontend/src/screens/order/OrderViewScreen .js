...
const OrderViewScreen = ({ history, match }) => {
    ...
    const renderModalPay = () => (
        ...
        >
            <h2 className="text-center">Ordem de pagamento</h2>
            <p className="text-center">O pedido já foi pago?.</p>
                ...
                <div className="row">
                    ...
                    {order.isPaid ? (
                        <div className="col-12 col-md-6">
                            <ViewBox
                                title={"Pago"}
                                paragraph={"O pedido ja foi pago"}
                                icon={"fas fa-check"}
                                color={"bg-success"}
                            />
                        </div>
                        ...
                        <div className="col-12 col-md-6">
                            <ViewBox
                                title={"Não Pago"}
                                paragraph={"O pedido ainda não foi pago"}
    ...
    const renderOrderPay = () => (
        <div className="card">
            <div className="card-header bg-success">Atualizar para pago</div>
            <div className="card-body">
                <button
                ...
                >
                    <ViewBox
                        title={`Pagar R$${order.total}`}
                        paragraph={`Clique para pagar`}
